...
const MOCK_COMMUNITIES = [
  {
    ...
    members: 128,
    unreadMessages: 5,
    upcomingEventsCount: 2, // Changed from `upcomingEvents`
    progress: 75,
    xp: 1250,
    level: 8,
    image: "/placeholder.svg?height=80&width=80",
    ...
    upcomingEvents: [
      { id: "101", title: "Algorithm Workshop", date: "2025-03-15T14:00:00", attendees: 28 },
      { id: "102", title: "Project Collaboration", date: "2025-03-20T16:30:00", attendees: 15 }
    ],
    leaderboard: [
      { id: "1", name: "User1", avatar: "/avatar-placeholder.png", xp: 2500 },
      { id: "2", name: "User2", avatar: "/avatar-placeholder.png", xp: 2200 }
    ]
  },
  {
    id: "2",
    ...
    members: 64,
    unreadMessages: 0,
    upcomingEventsCount: 1, // Changed from `upcomingEvents`
    progress: 45,
    xp: 890,
    level: 5,
    image: "/placeholder.svg?height=80&width=80",
    ...
    admins: ["Math Prof", "Number Guy"],
    learningPaths: [
      { id: "3", title: "Calculus", completedSteps: 4, totalSteps: 10, progress: 40 },
      { id: "4", title: "Linear Algebra", completedSteps: 3, totalSteps: 8, progress: 37 }
    ],
    upcomingEvents: [
      { id: "103", title: "Math Contest", date: "2025-03-18T10:00:00", attendees: 20 }
    ],
    leaderboard: [
      { id: "3", name: "MathGenius", avatar: "/avatar-placeholder.png", xp: 1800 },
      { id: "4", name: "AlgebraKing", avatar: "/avatar-placeholder.png", xp: 1650 }
    ]
  },
  {
    id: "3",
    ...
    members: 210,
    unreadMessages: 12,
    upcomingEventsCount: 3, // Changed from `upcomingEvents`
    progress: 60,
    xp: 1560,
    level: 10,
    image: "/placeholder.svg?height=80&width=80",
    ...
    admins: ["Language Pro", "Polyglot Pete"],
    learningPaths: [
      { id: "5", title: "Spanish Beginner", completedSteps: 12, totalSteps: 15, progress: 80 },
      { id: "6", title: "French Intermediate", completedSteps: 6, totalSteps: 12, progress: 50 }
    ],
    upcomingEvents: [
      { id: "104", title: "Spanish Conversation", date: "2025-03-14T18:00:00", attendees: 15 },
      { id: "105", title: "French Movie Night", date: "2025-03-22T19:30:00", attendees: 25 }
    ],
    leaderboard: [
      { id: "5", name: "LinguistPro", avatar: "/avatar-placeholder.png", xp: 3200 },
      { id: "6", name: "WordMaster", avatar: "/avatar-placeholder.png", xp: 2900 }
    ]
  }
];
